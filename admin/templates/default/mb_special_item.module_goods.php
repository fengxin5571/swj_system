...
<div class="index_block goods-list">
  ...
  <div class="title">
    <?php if($item_edit_flag) { ?>
    <h5>商品展示样式：</h5>
    <select name="good_style">
    <option value="0" <?php if($item_type=="goods"){echo "selected='selected'";}?>>类型一</option>
    <option value="1" <?php if($item_type=="goods_self"){echo "selected='selected'";}?>>类型二</option>
    </select>
