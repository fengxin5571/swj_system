...
class mb_specialControl extends SystemControl{
    ...
    public function special_item_saveOp() {
        ...
        $model_mb_special = Model('mb_special');
        $item_info = $model_mb_special->getMbSpecialItemInfoByID($_POST['item_id']);
        if($item_info['item_type']=="goods"){
            $item_type=$_POST['good_style']?"goods_self":"goods";
        }else{
            $item_type=$item_info['item_type'];
        }
        $result = $model_mb_special->editMbSpecialItemByID(array('item_type'=>$item_type,'item_data' => $_POST['item_data']), $_POST['item_id'], $_POST['special_id']); 
